...
// Market tag mapping: domein → Shopify market tag + land
const MARKET_MAP = {
...
router.get('/stores', async (req, res) => {
  try {
    ...
    // Per domein matchen op market_tag
    const markets = {};
...
router.get('/c1-categories', async (req, res) => {
  try {
    ...
    const result = c1CategoryService.calculateC1CategoryPerformance(conversa
